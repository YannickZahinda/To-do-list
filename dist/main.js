...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_app_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/app.js */ \"./modules/app.js\");\n/* harmony import */ var _modules_interactive_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/interactive.js */ \"./modules/interactive.js\");\n\n\n\n\nclass Task {\n  constructor(taskArray) {\n    this.taskArray = taskArray;\n  }\n\n  render = () => {\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_1__.renderTasks)(this.taskArray);\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(this.addtask, this.taskArray);\n    (0,_modules_app_js__WEBPACK_IMPORTED_MODULE_1__.editTask)(this.taskArray, this.addtask);\n    (0,_modules_interactive_js__WEBPACK_IMPORTED_MODULE_2__.clearByCompleted)(this.taskArray);\n    (0,_modules_interactive_js__WEBPACK_IMPORTED_MODULE_2__.markCompleted)(this.taskArray, this.addtask);\n  };\n\n  addtask = (data) => {\n    if (data) {\n      this.taskArray.push(data);\n      localStorage.setItem('taskArray', JSON.stringify(this.taskArray));\n    } else {\n      localStorage.setItem('taskArray', JSON.stringify(this.taskArray));\n    }\n  };\n}\n\nconst task = new Task(JSON.parse(localStorage.getItem('taskArray')) || []);\ntask.render();\ntask.addtask();\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
